function Y = circ_vmrnd2(theta, kappa, n)
% alpha = circ_vmrnd2(theta, kappa, n)
...
%
%   Examples
%    Y = circ_vmrnd2(0,5)            - draw a sample from VM(0,5)
%    Y = circ_vmrnd2(0,5,100)        - draw 100 samples from VM(0,5)
%    Y = circ_vmrnd2(0,[5 10],100)   - draw 100 samples from VM(0,5) and 100 from VM(0,10)
%    Y = circ_vmrnd2([-pi/2 pi/2],5) - draw one sample from VM(-pi/2,5) and one from VM(pi/2,5)
%
%   References:
